...
- Motivation: Most potential Stan users, especially those without degrees from
  statistics departments, cannot make good use of Probability Density Functions
- Probability Density Functions are like complex numbers in that they facilitate 
  theorems but are far removed from the real world most Stan users inhabit
- Probability Density Functions are intertwined with expectations and most Stan users
  do not have prior expectations in their heads
  
> - Easier to articulate probabilistic information through quantiles
> - Choosing a prior and choosing a transformation are flip sides of the same coin
> - Probability distributions defined by quantiles also tend to be more flexible
  and yield better sampling behavior
...
> - It seems helpful if $\mathbf{u}$ consists of nodes and extrema of $T_k$
...
* If not, quantiles rather than expectations is an easier entry point
...
* There more QPDs and some non-QPDs that are very flexible and have explicit inverse CDFs

> - Can these ideas be extended to multivariate distributions?
> - Most multivariate distributions are already characterized by transformations
> - Can use copulas, although that brings back density functions
